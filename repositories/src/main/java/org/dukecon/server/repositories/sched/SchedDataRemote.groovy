...
class SchedDataRemote {
    ...
    public Conference readConferenceData(String conferenceNameAndKey) {
        try {
            // Prepare the rest url by replacing conferences id and key in the template url.
            ...
            log.info("Rereading conferences data from '{}' for conferences '{}", baseConferenceUrl, conferenceId)
    ...
    public Conference readConferenceDataFallback(String conferenceNameAndKey) {
        try {
            ...
            log.info("Rereading data from backup '{}' for conferences '{}", backupPattern, conferenceId)
